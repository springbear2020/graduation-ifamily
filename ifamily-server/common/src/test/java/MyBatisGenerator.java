...
public class MyBatisGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\Repository\\ifamily\\service\\user" + "/src/main/java");
        // 去掉 Service 接口的首字母 I
        ...
        pc.setParent("cn.edu.whut.springbear.ifamily.common");
        ...
        // 包含的表
        strategy.setInclude("user", "user_login_log");
        // 数据库表映射到实体的命名策略
