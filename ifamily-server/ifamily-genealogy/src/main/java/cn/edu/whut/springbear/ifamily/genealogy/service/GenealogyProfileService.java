...
public interface GenealogyProfileService extends IService<GenealogyProfileDO> {
     ...
     * @return [1]更新成功
     */
    Integer increaseOne(Long genealogyId, Integer gender, Date deathDate);

    /**
     * 比较新、旧性别，若两者不一致则更新家族成员概况信息中的男、女人数，
     * 新性别对应的人数 +1，旧性别对应的人数 -1
     *
     * @param newGender   新性别
     * @param oldGender   旧性别
     * @param genealogyId 家族 ID
     ...
     * @return [true]更新成功
     */
    boolean changeByDeathDate(Date newDeathDate, Date oldDeathDate, Long genealogyId);
     ...
     * @return [1]更新成功
     */
    Integer decreaseOne(Long genealogyId, Integer gender, Date deathDate);
