...
public interface MemberService extends IService<PeopleDO> {
    ...
    /**
     * 查询家族人员世代分组列表，可根据家族人员姓名、性别以及生逝状态进行过滤查询
     *
     * @param memberQuery 查询条件：必须包含家族 ID，人员姓名、性别和生逝状态可选
     * @return 返回 Map 中包含了家族世代列表和每个列表下的家族人员
     */
    Object listGenerationMembers(MemberQuery memberQuery);
     ...
     * @return 家族成员信息
     */
    List<PeopleCardVO> listMemberByBatchUserIds(List<Long> userIds, Long genealogyId);
