<template>
  <div>
    ...
    <van-form @submit="handleSubmit">
      ...
      <!-- 简介、字辈歌 -->
      <van-field rows="2" :autosize="true" label="家族简介" type="textarea" maxlength="1000" size="large" placeholder="家族简介"
                 v-model.trim="formData.introduction" show-word-limit clearable/>
      <van-field rows="2" :autosize="true" label="字辈歌" type="textarea" maxlength="1000" size="large" placeholder="字辈歌"
