<template>
  <div>
    ...
    <van-grid direction="horizontal" :border="false" :column-num="5">
      ...
      <van-grid-item>
        <!--        <van-icon name="female" color="#ee0a24" class="iconfont" class-prefix="icon"/>-->
    ...
    <van-cell title="家庭关系">
      <template #label>
        <p>父亲：
          <people-tag :name="'冯世元'" :sex="0"/>
        </p>
        <p>母亲：</p>
        <p>配偶： </p>
        <p>子女：
          <people-tag :name="'冯学慧'" :sex="3" :right="true" :bottom="true"/>
          <people-tag :name="'刘纯洲'" :sex="1" :right="true" :bottom="true"/>
          <people-tag :name="'冯学良'" :sex="0" :right="true" :bottom="true"/>
        </p>
        <p>同胞：</p>
      </template>
    </van-cell>
    ...
    <van-cell title="个人相册">
      <template #label>
        <van-image v-for="index in 5" :key="index" width="100" height="100" class="members-people-image"
